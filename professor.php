                        ...
                        <div class="h-100 d-flex flex-column justify-content-center p-5">
                           ...
                           <form name="formProf" action="professor_salvar.php" method="post">
                              <div class="row g-3">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-floating">
                                       <input type="text" class="form-control border-0" id="cname" placeholder="" name="tempoExp">
                                       <label for="cname">Tempo de experiência</label>
                                    </div>
                                 </div>
                                 <div class="col-sm-12">
                                    <div class="form-floating">
                                       <input type="text" class="form-control border-0" id="cage" placeholder="" name="escolaAnt">
                                       <label for="cage">Onde já trabalhou?</label>
                                    </div>
                                 </div>
                                 <div class="col-sm-12">
                                    <div class="form-floating">
                                       <input type="text" class="form-control border-0" id="cage" placeholder="" name="turmaDis">
                                       <label for="cage">Turma disponível</label>
                                    </div>
                                 </div>
                                 <div class="col-12">
